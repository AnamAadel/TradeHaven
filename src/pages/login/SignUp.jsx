...
function SignUp() {
    const { signInWithGoogle, createUser, user, logout, setLoading, loading,  setUser, signInWithGithub } = useAuth();
                ...
                <div className="grid grid-cols-1 rounded-lg shadow-2xl overflow-hidden mx-auto container items-center bg-wite">
                    <div className="p-8">
                        ...
                        <div className='grid grid-cols-2 gap-10'>
                            ...
                            <a onClick={handleGoogleSignIn} className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                            ...
                            <div onClick={handleGihubSignIn} className="flex items-center justify-center mt-4  rounded-lg shadow-md hover:bg-gray-100">
                                <div className="px-4 py-3" >
                        ...
                        <div className="mt-4">
                            ...
                            <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" {...register("name", { required: true })} />
